...
{
    /// <summary>
    ///     Defines the <see cref="OutputClass" /> .
    /// </summary>
    public class OutputClass
    {
        ...
        {
            if (!_validate.ValidateStringIsNotNull(title)) return false;
            if (!_validate.ValidateStringHasLength(title)) return false;
            if (!_validate.ValidateStringIsNotNull(filePath)) return false;
            if (!_validate.ValidateStringHasLength(filePath)) return false;
            if (!_validate.ValidateFileExists(filePath, true)) return false;
