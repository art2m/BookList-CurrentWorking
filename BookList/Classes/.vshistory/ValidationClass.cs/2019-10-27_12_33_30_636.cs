...
1.0.0.0
10/27/2019
/// Code Element Name: ValidateStringHasLength
/// Code Element Kind:Method with return value
/// <summary>
/// Validate this is not an empty string.
/// </summary>
/// Parameters:
value String
...
Boolean
        ...
        /// <summary>Validates the string value not empty not white space.</summary>
        /// <param name="value">The value.</param>
        /// <returns></returns>
