...
namespace BookList.Classes
{
    ...
    public static class ValidationClass
    {
        ...
        public static bool ValidateSpellingWord(string value)
        {
        ...
        public static bool ValidateStringValueNotEmptyNotWhiteSpace(string value)
        {
            ...
            try
            {
                MyMessagesClass.ErrorMessage = "The value is not valid. It is empty or null. Exiting operation. "
                                               + value;
        ...
        /// <changed>art2m,6/6/2019</changed>
        /// ********************************************************************************
        public static bool ValidateDirectoryExists(string dirPath)
        {
            try
            {
        ...
        /// <changed>art2m,6/6/2019</changed>
        /// ********************************************************************************
        public static void CheckForInvalidPathCharacters(string value)
        {
        ...
        /// <changed>art2m,6/6/2019</changed>
        /// ********************************************************************************
        public static void CheckForInvalidFileNameCharacters(string fileName)
        {
        ...
        /// <changed>art2m,6/6/2019</changed>
        /// ********************************************************************************
        public static void ValidatePathToLong(string value)
        {
            MyMessagesClass.NameOfMethod = MethodBase.GetCurrentMethod().Name;
            try
            {
