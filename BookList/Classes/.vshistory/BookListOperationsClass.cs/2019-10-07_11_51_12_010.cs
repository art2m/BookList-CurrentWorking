...
namespace BookList.Classes
{
    ...
    public class BookListOperationsClass
    {
        ...
        /// </summary>
        /// <returns></returns>
        public List<string> ReadAuthorsFileNames()
        {
        ...
        public void ReadCurrentAuthorsListFile(List<string> authors)
        {
            var bookListPath = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData);
            var authorsList = BookListReadWriteClass.ReadAuthorsListFile(bookListPath);
