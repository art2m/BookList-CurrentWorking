...
namespace BookList.Classes
{
    ...
    {
        public void CheckBookListStringIsFileName(string value)
        {
        ...
        private void CheckForMultipleAuthors(string authorName)
        {
            if (!authorName.Contains("_"))
            {
                 BookListPropertiesClass.CurrentAuthorName = authorName;
                 return;
            }

            string[] authors = authorName.Split('_');
