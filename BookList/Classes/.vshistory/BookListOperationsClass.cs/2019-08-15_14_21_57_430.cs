...
namespace BookList.Classes
{
    ...
    public class BookListOperationsClass
    {
        ...
        private bool CheckIfValueIsAuthorName(string value)
        {
            ...
            if (!this.GetFileNameFromString(value)) return false;

            return true;
        }

        private bool GetFileNameFromString(string value)
        {
            ...
            if (!ValidationClass.ValidateStringValueNotEmptyNotWhiteSpace(fileName)) return false;
