...
namespace BookList.Classes
{
    ...
    /// </summary>
    public class MyMessageBoxClass
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MyMessageBoxClass"/> class.
        /// </summary>
        public MyMessageBoxClass()
        {
        }
        ...
        public bool ShowWarningMessageBox()
        {
            ...
            if (string.IsNullOrEmpty(this.Msg)) return false;
            if (string.IsNullOrWhiteSpace(this.NameOfClass)) return false;
            if (string.IsNullOrEmpty(this.NameOfMethod)) return false;
