...
namespace BookList.Source
{
    ...
    public partial class RawDataInput : Form
    {
        ...
        private void OnReplaceBookInformationDataButton_Clicked(object sender, EventArgs e)
        {
            ...
            var lstTemp = this.FillTempListWithListBoxData();
            ...
            {
                this.lstRawData.Items.Add(lstTemp[j].ToString());
            }

            this.lstRawData.Items.Add(sb.ToString());
        }

        private List<string> FillTempListWithListBoxData()
        {
