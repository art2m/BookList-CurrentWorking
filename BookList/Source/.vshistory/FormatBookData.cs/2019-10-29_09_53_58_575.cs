...
namespace BookList.Source
{
    ...
    public partial class UnformattedData : Form
    {
        ...
        private void OnSelectedTextTitleButton_Clicked(object sender, EventArgs e)
        {
            ...
            this.ValidateUserHasMadeTextSelection(this.title);
        ...
        private bool CheckUserSelectedTitleText()
        {
        ...
        private void GetSelectedTitleText()
        {
            ...
            {
                throw new InvalidExpressionException("The Title and series text should not be the same.");
            }
        }
        ...
        private void ValidateUserHasMadeTextSelection(string value)
        {
            if (!ValidationClass.ValidateStringHasLength(value))
                throw ArgumentNullException("You must select text.");
        }
    }
}