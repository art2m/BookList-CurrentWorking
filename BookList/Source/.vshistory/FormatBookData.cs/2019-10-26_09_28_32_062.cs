...
namespace BookList.Source
{
    ...
    public partial class RawDataInput : Form
    {
        ...
        private void FillListBoxWithUnformattedBookInformation()
        {
        ...
        {
            // TODO: Check to see if any unformated data for the selected author
        ...
        private void LoadRawData()
        {
            ...
            this.FillListBoxWithUnformattedBookInformation();
        }
        ...
        private void OnSaveAllChangesMenuItem_Clicked(object sender, EventArgs e)
        {
            ...
            this.FillCollectionFromListBox();
        }
