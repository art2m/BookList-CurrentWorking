...
{
    public partial class ModifyAuthorsBookList : Form
    {
        public ModifyAuthorsBookList()
        {
            InitializeComponent();
        }
        ...
        private void OnSearchBookListAuthorsButton_Clicked(object sender, EventArgs e)
        {
