...
namespace BookList.Source
{
    ...
    public partial class AdditionOfBookAuthors : Form
    {
        ...
        private string OneBookAuthorName()
        {
            if (string.IsNullOrEmpty(this.txtFirstAuthor.Text.Trim())) return string.Empty;

            var author = this.txtFirstAuthor.Text.Trim();

            author = this.AddDashToFileName(author);

            return this.AddFileExtension(author);
        }

        private string AddDashToFileName(string author)
        {
            ...
            foreach (var letter in author)
            {
                ...
                {
                    authorName = authorName + letter.ToString();
                }
            }
