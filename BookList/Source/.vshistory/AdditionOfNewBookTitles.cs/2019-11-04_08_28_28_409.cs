...
namespace BookList.Source
{
    ...
    public partial class AdditionOfBookTitles : Form
    {
        ...
        {
            if (this.chkSeries.Checked) this.isBookSeries = true;
        ...
        /// </summary>
        /// <param name="sender">The sender<see cref="object" />The source of the event.</param>
        /// <param name="e">The e<see cref="System.EventArgs" />The instance containing the event data.</param>
        private void OnSelectExistingAuthorButton_Clicked(object sender, EventArgs e)
        {
        }
