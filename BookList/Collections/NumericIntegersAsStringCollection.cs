// BookList
// 
// NumericIntegersAsStringCollection.cs
// 
// Arthur Melanson
// 
// art2m
...
{
    /// <summary>Holds numeric integer values as string.</summary>
    public static class NumericIntegersAsStringCollection
    {
        /// <summary>
        ///     The integer number
        ///     as string.
        /// </summary>
        private static readonly List<string> Number = new List<string>();
        ...
        /// <summary>
        ///     Check to see if the number list all ready contains the <paramref name="item" />.
        /// </summary>
        ...
        public static string[] GetAllItems()
        {
            ...
            for (var i = 0; i < count; i++) origPath[i] = Number[i];
