...
namespace BookList.Collections
{
    public static class AuthorTitlesDictionaryCollection
    {
        ...
        {
            Dictionary<string, List<string>>.KeyCollection lstKeys = new Dictionary<string, List<string>>.KeyCollection();

            for (var index = 0; index < DicData.Count; index++)
            {
                lstKeys = DicData.Keys
            }
        }
